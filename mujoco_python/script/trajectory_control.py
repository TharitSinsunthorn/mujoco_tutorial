...
xml_path = '/home/tharitto-chan/mujoco_tutorial/mujoco_python/model/double_pendulum.xml' #xml file (assumes this is in the same folder as this file)
...
def controller(model, data):
    ...
    q_ref1 = a_jnt1[0] + a_jnt1[1]*time + a_jnt1[2]*(time**2) + a_jnt1[3]*(time**2)
